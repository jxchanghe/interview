...
namespace qh
{
    ...
    private:
		bool ParseOneLine(std::string& strLine, std::string& curSection, const std::string& key_value_seperator = "=");
		 //! key是由ini文件中的key + key所属的section复合而成
		std::map<std::string, std::string> mapIniData;
